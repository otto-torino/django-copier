    ...
    def get_fieldsets(self, request, obj=None):
        ...
        fieldsets = [
            (_("Main"), {
                ...
                "classes": (
                    "baton-tabs-init",
                    "baton-tab-fs-image_file",
                    "baton-tab-fs-download_file",
                    "baton-tab-fs-advanced",
                ) if not obj else (
                    "baton-tabs-init",
                    "baton-tab-fs-advanced",
                )
        ...
        for row in self.model._file_mixin_fieldsets:
            if getattr(obj, row["file_field"], None):
                ...
                fieldsets.append(
                    (
                        row["verbose_name"].title(),
                        {
                            "fields": row["fields"],
                            "classes": ["tab-fs-%s" % row["file_field"].lower()]
                        },
                    )
                )
        ...
        if advanced:
            fieldsets.append((_("Advanced"), {"fields": advanced, "classes": ["tab-fs-advanced"]}))
        return fieldsets
